---
description: Cross-phase gap scan for active jiji DDs — reads the design doc and landed commit history, surfaces residual invariant gaps and audit surfaces not covered by any landed phase. Writes a proposal doc to private/docs/architect-passes/.
...
4. Write a proposal doc to `private/docs/architect-passes/YYYY-MM-DD-<target>.md`.
